...
1. **Preprocessing scripts**  
   ...
   - Includes basic video and frame manipulation tools.

2. **Evaluation scripts**  
   - Tools for assessing generated videos.  
   - Implemented metrics such as temporal consistency and appearance-based evaluations.
